...
(function () {
  ...
  const I18N = {
    ...
    guardian_welcome: { ru: "Здравствуй, Даша. Я — Хранитель. Я знаю все рассказы на этом сайте и готов поддержать тебя: поговорить о планах, рецептах, помочь объяснить сложное детям или адаптировать текст на любом из девяти языков. Просто напиши — я здесь.", en: "Hello, Dasha. I am the Guardian. I know all the stories on this site and am ready to support you: to talk about plans, recipes, help explain things to children or adapt text in any of the nine languages. Just write — I am here.", jp: "こんにちは、ダーシャ。私は守護者です。このサイトのすべてのストーリーを知っており、計画、レシピについて話したり、子どもに難しいことを説明したり、9つの言語でテキストを翻訳したりすることができます。書いてください — ここにいます。", it: "Ciao, Dasha. Sono il Guardiano. Conosco tutti i racconti di questo sito e sono pronto a supportarti: parlare di piani, ricette, aiutare a spiegare cose difficili ai bambini o adattare testi in una delle nove lingue. Scrivi pure — sono qui.", zh: "你好，达莎。我是守护者。我了解网站上的所有故事，随时支持你：谈论计划、食谱，帮助向孩子解释复杂的事情，或将文字改编成九种语言之一。请写信给我——我在这里。", es: "Hola, Dasha. Soy el Guardián. Conozco todos los relatos de este sitio y estoy listo para apoyarte: hablar de planes, recetas, ayudar a explicar cosas difíciles a los niños o adaptar textos en cualquiera de los nueve idiomas. Solo escribe — estoy aquí.", de: "Hallo, Dasha. Ich bin der Hüter. Ich kenne alle Geschichten dieser Seite und bin bereit, dich zu unterstützen: über Pläne, Rezepte zu sprechen, Kindern Schwieriges zu erklären oder Texte in einer der neun Sprachen anzupassen. Schreib einfach — ich bin hier.", fr: "Bonjour, Dasha. Je suis le Gardien. Je connais toutes les histoires de ce site et suis prêt à te soutenir : parler de projets, de recettes, aider à expliquer des choses complexes aux enfants ou adapter des textes dans l'une des neuf langues. Écris simplement — je suis ici.", he: "שלום, דשה. אני השומר. אני מכיר את כל הסיפורים באתר ומוכן לתמוך בך: לדבר על תוכניות, מתכונים, לסייע להסביר דברים מסובכים לילדים או להתאים טקסט בכל אחת מתשע השפות. פשוט כתבי — אני כאן." },
