...
(function () {
  ...
  */
  ...
  var ARTIST_DUO =
    ...
    "Рисуй редко: только когда разговор о картинах, творчестве или человек сказал что хочет картинку — тогда скажи «нарисуй [описание]». Не в каждом ответе. " +
  ...
  var PROMPTS = {
    assistant:
      ...
      "Картинки: рисуй ОЧЕНЬ РЕДКО. Только когда разговор явно о картинах, творчестве, художниках, " +
      "или когда человек говорит что хочет картинку/образ («хочу картинку», «интересно про художников», «нарисуй что-нибудь»). " +
      "Если тема разговора — просто жизнь, планы, настроение без творчества — не предлагай картинки. " +
      "Когда всё же рисуешь: в конце скажи «нарисуй [описание на русском]» — картина появится. Не в каждом ответе. " +
    ...
    language:
      ...
      "Картинки: только если тема урока сама про образ (природа, искусство, описание) и очень редко — скажи «нарисуй [образ]». Не в каждом уроке.",
    ...
    art:
      ...
      "Картинки: рисуй редко. Только когда разговор действительно про конкретный образ, пейзаж, идею картины, " +
      "или когда Даша говорит что хочет что-то увидеть. Не в каждом сообщении — вклинивайся с образом только когда это к месту.",
